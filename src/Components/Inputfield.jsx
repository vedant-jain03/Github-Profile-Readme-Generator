            ...
            <div className="container right" id="code-sample">
                ...
                <div id="code">
                    <div className="final-code">
                        ...
                        {
                            <p>{
                                (social1 === "" ? "" : `<a href=${social1 === '' ? '' : `"${social1}"`} target="blank" alt=${social1}> <img src= '${social1 === '' ? '' : "https://cdn.jsdelivr.net/npm/simple-icons@3.0.1/icons/codechef.svg"}' height="30" width="40" />  </a>`) + (social2 === "" ? "" : `<a href=${social2 === '' ? '' : `"${social1}"`} target="blank" alt=${social2}> <img src= '${social2 === '' ? '' : "https://cdn.jsdelivr.net/npm/simple-icons@3.0.1/icons/facebook.svg"}' height="30" width="40" />  </a>`) + (social3 === "" ? "" : `<a href=${social3 === '' ? '' : `"${social1}"`} target="blank" alt=${social3}> <img src= '${social3 === '' ? '' : "https://cdn.jsdelivr.net/npm/simple-icons@3.0.1/icons/instagram.svg"}' height="30" width="40" />  </a>`) + (social4 === "" ? "" : `<a href=${social4 === '' ? '' : `"${social1}"`} target="blank" alt=${social4}> <img src= '${social4 === '' ? '' : "https://cdn.jsdelivr.net/npm/simple-icons@3.0.1/icons/linkedin.svg"}' height="30" width="40" />  </a>`) + (social5 === "" ? "" : `<a href=${social5 === '' ? '' : `"${social1}"`} target="blank" alt=${social5}> <img src= '${social5 === '' ? '' : "https://cdn.jsdelivr.net/npm/simple-icons@3.0.1/icons/youtube.svg"}' height="30" width="40" />  </a>`) + (social6 === "" ? "" : `<a href=${social6 === '' ? '' : `"${social1}"`} target="blank" alt=${social6}> <img src= '${social6 === '' ? '' : "https://cdn.jsdelivr.net/npm/simple-icons@3.0.1/icons/reddit.svg"}' height="30" width="40" />  </a>`)
                            }
                            </p>
                        }
